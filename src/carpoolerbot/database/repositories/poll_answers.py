...
def set_driver_id(user_id: int, poll_id: str, poll_option_id: int, driver_id: int, *, toggle: bool = False) -> None:
    ...
    retry_on_db_error(_set_driver_id)
